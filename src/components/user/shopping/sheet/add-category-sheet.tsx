      ...
      <View className="flex-1 items-center bg-[#F7F7F7] dark:bg-[#0A1220]">
        ...
        <View className="flex-row justify-between  w-full">
          ...
          <Text
            ...
            {translate('pick_category_for_item')}
          </Text>
          <TouchableOpacity
            style={{
              height: 50,
        ...
        <BottomSheetScrollView
          ...
          <View className="mt-5">
            <ItemItems
              ...
              onNavigateCreateRoom={onNavigateCreateCategory}
              pickRoom={pickCategory}
      ...
      <>
        <View
          ...
          <TouchableOpacity
            ...
            <View
              className="bg-[#EAEAEA] dark:bg-[#252D3B] justify-center items-center rounded-xl"
              style={{
                // width: screenWidth * 0.3,
                width: '100%',
                height: undefined,
