...
const AddListSheet = ({
    ...
    const [pickIcon, setPickIcon] = React.useState<ImageSourcePropType>(Icon13)
            ...
            <TouchableOpacity className=' bg-white  mt-3 justify-center rounded-lg  ' style={{
                ...
                <View className='flex-row justify-between items-center'>
                    <View className='flex-row  items-center '>
                        <Image source={pickIcon} style={{ width: screenWidth * 0.1, height: screenWidth * 0.1 }} />
                            ...
                            iconList.map((icon, index) => {
                                if (index > 0) {
                                    return <TouchableOpacity key={index} className='flex-row items-center justify-between mr-3 mb-2' onPress={() => {
                                        ...
                                        <Image source={icon} style={{ width: screenWidth * 0.08, height: screenWidth * 0.08 }} />
                                    </TouchableOpacity>
                                }
