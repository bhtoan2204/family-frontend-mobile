...
function AccordionItem({ children, title, persistComponent, isExpanded }: AccordionItemPros): JSX.Element {
    const [expanded, setExpanded] = useState(isExpanded != null ? isExpanded : false);
    ...
    return (
        <View style={styles.accordContainer}>
            <TouchableOpacity style={styles.accordHeader} onPress={toggleItem}>
                <Text style={styles.accordTitle} className='text-xl font-medium'>{title}</Text>
                <View style={{
                    marginRight: 10
