...
} from 'src/redux/slices/CheckListSlice';
    ...
    <BottomSheet
      ...
      <View className="flex-1">
        {isEditing ? (
          ...
          <View className="w-full  flex-row justify-between  items-center py-3 bg-white px-4 z-10">
            <View className=" flex-row items-center flex-1"></View>
            ...
            <View className=" flex-1   ">
              ...
              <View
                ...
                <TouchableOpacity
                  className="bg-gray-200 p-1 rounded-full z-10"
                  onPress={() => {
        ...
        <KeyboardAvoidingView className="flex-1 " behavior="padding">
          <ScrollView
            ...
            scrollEnabled={isEditing == false}>
            {isEditing ? (
              <View>
                <TextInput
                  editable
                  placeholder={translate('Checklist name')}
                  value={name}
              ...
              <View className="">
                <View className="px-4 py-2 ">
                  <TouchableOpacity
                    ...
                    <TouchableOpacity
                      className="w-7 h-7 rounded-full mr-4 flex flex-col items-center justify-center"
                      style={{
                        borderWidth: checklist_item.is_purchased ? 0 : 2,
                        borderColor: iOSGrayColors.systemGray.accessibleDark,
                        backgroundColor: checklist_item.is_purchased
                          ? iOSColors.systemGreen.defaultLight
                          : 'transparent',
                      }}
                      onPress={async () => {
                  ...
                  <TouchableOpacity
                    ...
                    <Text
                      className="text-base"
                      style={{color: iOSGrayColors.systemGray.accessibleDark}}>
                      {translate('Description')}: {checkListDescription}
                    </Text>
                  </TouchableOpacity>
                    ...
                    {checkListdueDate == null ? (
                      ...
                      <>
                        ...
                        <Text
                          ...
                          {checkListdueDate == null
                            ? translate('Set reminder')
                            : translate('Reminder date') +
                              ':' +
                              buildDate(new Date(checkListdueDate))}
                        </Text>
                      </>
                    )}
                  </TouchableOpacity>
      ...
      <CheckListTimePickerSheet
        refRBSheet={timePickerRBSheet}
        setSave={handleUpdateDueDate}
        initialValue={new Date(checklist_item.reminder_date)}
      />
      <NumberPickerSheet
        refRBSheet={quantityPickerRef}
        initialNumber={checkListquantity}
