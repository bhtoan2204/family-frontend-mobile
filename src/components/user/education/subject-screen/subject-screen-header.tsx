...
interface EducationScreenHeaderProps {
    ...
    navigationBack?: () => void
    addComponentScoreSheetRef: React.RefObject<BottomSheet>
}
...
const SubjectScreenHeader = ({
    imageUrl, idFamily, title, handleEditImage, handleEditTitle, handleDeleteItem, navigationBack, addComponentScoreSheetRef
...
export default SubjectScreenHeader