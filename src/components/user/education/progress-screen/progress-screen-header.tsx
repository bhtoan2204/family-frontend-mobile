...
const ProgressScreenHeader = ({
    imageUrl, idFamily, handleEditImage, handleEditTitle, handleDeleteItem, navigationBack, addCourseBottomSheetRef
                ...
                >
                    <View className='w-full absolute z-10 flex-row justify-between items-center py-3 mt-5'>
                        ...
                        <BlurView intensity={35} tint='dark' className='px-3 overflow-hidden rounded-lg '>
                            <View >
                                <Text className='text-lg font-semibold text-white' >Courses</Text>
                            </View>
                        </BlurView>
                        ...
                        <BlurView intensity={35} tint='dark' className='flex-row items-center  mr-1 rounded-lg overflow-hidden'>
                            <TouchableOpacity className='' onPress={() => {
                                addCourseBottomSheetRef.current?.expand()
                            }}>
...
export default ProgressScreenHeader