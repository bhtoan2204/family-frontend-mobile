...
const AddMemberEducationSheet = ({ bottomSheetRef, setMemberEducationDatas, members }: { bottomSheetRef: React.RefObject<RBSheet>, setMemberEducationDatas: React.Dispatch<React.SetStateAction<Education[]>>, members: Member[] }) => {
