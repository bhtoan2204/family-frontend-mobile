...
const MemberEducationItem = ({ data, onPress }: { data: Education, onPress: () => void }) => {
        ...
        <TouchableOpacity className=' h-auto  mt-4  ' onPress={onPress}>
            <View className='flex-row items-center bg-white p-4'>
                ...
                <View className='flex-1'>
                    <Text className='font-semibold text-lg' style={{ color: COLORS.primary }}>{data.firstname} {data.lastname}</Text>
