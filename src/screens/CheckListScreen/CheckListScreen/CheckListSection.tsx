...
const CheckListSection: React.FC<{
  title: string;
  data: CheckListCategoryInterface[];
  handleNavigateCheckListDetail: (id_checklist: number) => void;
}> = ({title, data, handleNavigateCheckListDetail}) => {
  return (
      ...
      <View style={styles.sectionContainer}>
        ...
        {data.map(item => (
          <TouchableOpacity
            ...
            <View
              className="px-4 py-4 my-2 rounded-xl"
              style={{
                backgroundColor:
                  shoppingListItemColorInside[item.id_item_type - 1],
              }}>
              <View
                style={{
