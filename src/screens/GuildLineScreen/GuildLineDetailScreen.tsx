          ...
          {guildLineSteps && (
            <>
              <View className="h-[50%] w-[90%] flex-col justify-center items-center mb-10  rounded-full mx-4 ">
                <TouchableOpacity
                  disabled={isKeyboardVisible == true}
                  onPress={() => {
                    console.log(currentStep);
                  ...
                  <Image
                    source={
                      guildLineSteps[currentStep].imageUrl == null ||
                      guildLineSteps[currentStep].imageUrl == '' ||
                      guildLineSteps[currentStep].imageUrl == undefined
                        ? Img
                        : {uri: guildLineSteps[currentStep].imageUrl}
                    }
                    resizeMode="cover"
                    style={{
              ...
              <View className="bg-white  w-full">
                    ...
                    return (
                      <TouchableOpacity
                        style={{
                          ...
                          width:
                            currentStep === index
                              ? screenWidth / guildLineSteps.length - 5
                              : screenWidth / guildLineSteps.length - 12,
                          backgroundColor:
                            currentStep === index ? COLORS.primary : '#d1d1d1',
                        }}
                ...
                {!isAdding && !isEditing ? (
                  <TouchableOpacity
                    ...
                    <Text className="text-center px-4 text-lg mt-5 text-[#a1a1a1]">
                      {guildLineSteps[currentStep].description != '' &&
