...
const GuildLineScreen: React.FC<GuildLineScreenProps> = ({
  ...
  const [pickedNameGuideline, setPickedNameGuideline] =
    React.useState<string>('');
  const [pickedDescriptionGuideline, setPickedDescriptionGuideline] =
    React.useState<string>('');
  ...
  return (
    <View className="flex-1 bg-[#F7F7F7] dark:bg-[#0A1220]">
      ...
      <ScrollView
        ...
        <View className="flex-row px-3 py-2">
          <TouchableOpacity
            ...
            style={{
              ...
              borderBottomColor:
                tab == 0 ? iOSColors.systemBlue.defaultLight : undefined,
          ...
          <TouchableOpacity
            ...
            style={{
              borderBottomColor:
                tab == 1 ? (isDarkMode ? 'white' : 'black') : undefined,
        ...
        <Animatable.View
          animation={tab == 0 ? 'slideInLeft' : 'slideInRight'}
          key={tab}
          duration={400}
          className=""
          style={{}}>
      ...
      <TouchableOpacity
        className={`absolute rounded-full  bottom-5 right-5  bg-[#66C0F4] items-center justify-center transition ${isScrollDown ? 'opacity-30' : ''}`}
        style={{
      ...
      />
      <UpdateGuidelineSheet
        bottomSheetRef={updateGuidelineBottomSheetRef}
        id_family={id_family!}
