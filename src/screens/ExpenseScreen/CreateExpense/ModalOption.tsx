    ...
    <Modal
      ...
      <View style={[styles.modalContainer]}>
        <TouchableOpacity
          ...
          <View style={[styles.dropdownMenu, {backgroundColor: color.background, borderColor: color.background}]}>
            <TouchableOpacity onPress={() => handleOptionPress('Expense')}>
              <View style={[styles.menuItem, {borderBottomColor: color.text} ]}>
                <Image
                  ...
                  style={styles.avatar}
                />
                <Text style={[styles.text, {color: color.text}]}>{translate('Expense')}</Text>
            ...
            <Image
                  ...
                  style={styles.avatar}
                />
          <Text style={[styles.text, {color: color.text}]}>{translate('Income')}</Text>
                <View style={styles.checkIcon}>
                  {selectedMenu === 'Income' && (
                    <Icon name="checkmark-sharp" size={30} color="green" />
                  )}
            ...
            <Image
                  ...
                  style={styles.avatar}
                />
              <Text style={[styles.text, {color: color.text}]}>{translate('Utilities')}</Text>
                <View style={styles.checkIcon}>
