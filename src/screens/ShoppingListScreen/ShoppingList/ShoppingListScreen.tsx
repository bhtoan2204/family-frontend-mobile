                        ...
                        </> : <>
                            {
                                shoppingListType.length > 0 && shoppingListType.map((item, index) => {
                                    ...
                                    return <ShoppingListCategoryItem
                                        ...
                                        category_name={item.type_name_en} total_items={total_items}
...
const ShoppingListCategoryItem = ({ id_category, category_name, total_items, icon_url, handleNavigateCategory, scheme }: ShoppingListCategoryItemProps) => {
        ...
        <View className='flex-1 w-full items-center flex-row my-2 justify-between '>
            <View className='ml-6 items-center flex-row'>
                <View className='p-3 mr-3  rounded-full items-center justify-center' style={{
                    ...
                    <Image source={{ uri: icon_url }} style={{
