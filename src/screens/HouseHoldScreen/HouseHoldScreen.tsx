...
const household_items = [
  {
    ...
    item_imageurl:
      'https://storage.googleapis.com/famfund-bucket/household/household_bd94ba3a-b046-4a05-a260-890913e09df9_1713451417048',
    id_category: 1,
  },
  {
    id_household_item: 5,
    ...
    item_imageurl:
      'https://storage.googleapis.com/famfund-bucket/household/household_bd94ba3a-b046-4a05-a260-890913e09df9_1713451468168',
    id_category: 1,
  },
  {
    id_household_item: 6,
    ...
    item_imageurl:
      'https://storage.googleapis.com/famfund-bucket/household/household_bd94ba3a-b046-4a05-a260-890913e09df9_1713454442646',
    id_category: 1,
  },
  {
    id_household_item: 7,
    ...
    item_description: 'cái tủ lạnh cùi vãi',
    item_imageurl:
      'https://storage.googleapis.com/famfund-bucket/household/household_bd94ba3a-b046-4a05-a260-890913e09df9_1713454456027',
    id_category: 1,
  },
  {
    id_household_item: 8,
    ...
    item_description: 'cái tủ lạnh cùi vãi',
    item_imageurl:
      'https://storage.googleapis.com/famfund-bucket/household/household_bd94ba3a-b046-4a05-a260-890913e09df9_1713454463179',
    id_category: 1,
  },
  {
    id_household_item: 9,
    ...
    item_description: 'cái tủ lạnh cùi vãi',
    item_imageurl:
      'https://storage.googleapis.com/famfund-bucket/household/household_bd94ba3a-b046-4a05-a260-890913e09df9_1713454518267',
    id_category: 1,
  },
  {
    ...
    item_description: 'cái tủ lạnh cùi vãi',
    item_imageurl:
      'https://storage.googleapis.com/famfund-bucket/household/household_bd94ba3a-b046-4a05-a260-890913e09df9_1713454576319',
    id_category: 1,
  },
  {
    ...
    item_imageurl:
      'https://storage.googleapis.com/famfund-bucket/household/household_bd94ba3a-b046-4a05-a260-890913e09df9_1713502246879',
    id_category: 1,
  },
  {
...
const HouseHoldScreen: React.FC<HouseHoldScreenProps> = ({
  ...
  const [householdCategory, setHouseholdCategory] = React.useState<
    HouseHoldCategoryInterface[]
  >(household_category_dat);
  const [householdItems, setHouseholdItems] =
    React.useState<HouseHoldItemInterface[]>(household_items);
  const [choosenCategoryIndex, setChoosenCategoryIndex] =
    React.useState<number>(0);
  const [choosenCategoryId, setChoosenCategoryId] = React.useState<number>(
    householdCategory[0].id_category,
  );
  const categoryRefScroll = useRef<any>(null);
  const showCategoryItems = () => {
    const categoryItems = householdItems.filter(
      item => item.id_category === choosenCategoryId,
    );
    return (
      <View className="mt-2">
        {categoryItems.map((item, index) => (
          <HouseHoldItem
            ...
            setHouseHoldItem={setHouseholdItems}
            index={index}
          />
        ))}
      </View>
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: '#fff'}}>
      <View className="flex-1 bg-[#F7F7F7]">
        ...
        <ScrollView>
          <View style={{flex: 1}}>{showCategoryItems()}</View>
        </ScrollView>
        <AddHouseHoldItemSheet
          refRBSheet={refRBSheet}
          setHouseHoldItem={setHouseholdItems}
          id_category={choosenCategoryId}
          id_family={id_family!}
        />
      </View>
    </SafeAreaView>
