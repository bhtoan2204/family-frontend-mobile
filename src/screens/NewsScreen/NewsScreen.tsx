      ...
      return <ScrollView
        ...
        {newsCategory.map((category, index) => (
          <TouchableOpacity
            ...
            className={`${choosenCategoryIndex === index ? 'border-b-2 ' : ''}`}>
            <Text
              style={
                choosenCategoryIndex == index
                  ? { fontSize: 16, fontWeight: '600', color: (isDarkMode ? 'white' : 'black') }
                ...
                <View className="ml-4 flex-1  ">
                  ...
                  <View className="flex-row align-top rounded-lg   ">
                    <View
                      ...
                      style={{
                        backgroundColor:
                          isDarkMode ? categoryColors[choosenCategoryIndex].backgroundDarkColor : categoryColors[choosenCategoryIndex].backgroundColor,
                      }}>
                      <Text
                        className="font-semibold"
                        style={{
                          color: isDarkMode ? categoryColors[choosenCategoryIndex].textDarkColor : categoryColors[choosenCategoryIndex].textColor,
                        }}>
    ...
    return (
      <View style={{ flexDirection: 'row', justifyContent: 'center', marginVertical: 10 }}>
        <TouchableOpacity
          ...
          <Text style={{ color: currentPage === 1 ? COLORS.gray : 'black' }}>Prev</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          style={{ paddingHorizontal: 10 }}>
          <Text style={{ color: currentPage === totalPages ? COLORS.gray : 'black' }}>Next</Text>
        </TouchableOpacity>
      </View>
    );
  };
